...
BEGIN
    ...
    -- Insert into tickets
    INSERT INTO tickets (pnr_number, train_id, passenger_id, journey_date, seat_number, status, total_fare)
    VALUES (pnr_out, p_train_id, p_passenger_id, p_journey_date, v_seat_number, v_status, v_fare);
...
BEGIN
    ...
    SELECT ticket_id, train_id, status INTO v_ticket_id, v_train_id, v_status 
